class Game{
    ...
    play(){
        ...
        for(var plr in allPlayers){
           ...
           fill("white");
           text("SCORE for PLAYER 1"+(" : ") + allPlayers.player1.score,100,100);
           text("SCORE for PLAYER 2"+(" : ") + allPlayers.player2.score,700,100);
        }
    ...
    //Making the fruits disappear when touching the baskets and incrementing the score  
